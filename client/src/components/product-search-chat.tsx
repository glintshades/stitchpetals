...
export default function ProductSearchChat() {
  ...
  return (
    <Card className="fixed bottom-6 right-6 w-80 max-w-[calc(100vw-3rem)] h-[500px] max-h-[calc(100vh-3rem)] shadow-xl z-50 bg-white">
      ...
      <CardContent className="p-0 h-full flex flex-col">
        <Tabs value={activeTab} onValueChange={handleTabChange} className="h-full flex flex-col">
          ...
          <TabsContent value="search" className="h-full flex flex-col m-0">
